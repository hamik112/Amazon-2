...
def get_reg(opener,url,data={},referer={}):
	...
	postdata=data
        ...
        content = f.read()
        return content
reg_page = get_get_reg(opener,reg_url,"","","")
reg_tree = html.fromstring(reg_page)

appActionToken = '//form/input[@name="appActionToken"]/@value'
appAction = '//form/input[@name="appAction"]/@value'
max_auth_age = '//form/input[@name="openid.pape.max_auth_age"]/@value'
return_to = '//form/input[@name="openid.return_to"]/@value'
prevRID = '//form/input[@name="prevRID"]/@value'
dentity = '//form/input[@name="openid.identity"]/@value'
assoc_handle = '//form/input[@name="openid.assoc_handle"]/@value'
mode = '//form/input[@name="openid.mode"]/@value'
pape = '//form/input[@name="openid.ns.pape"]/@value'
claimed_id = '//form/input[@name="openid.claimed_id"]/@value'
pageId = '//form/input[@name="pageId"]/@value'
ns = '//form/input[@name="openid.ns"]/@value'
claimToken = '//form/input[@name="claimToken"]/@value'
customerName = gen_two_words(split=' ', lowercase=False) 
password = 'jjkcs123'
passwordCheck = 'jjkcs123'
...
edit_tree = html.fromstring(editdata)

PAYMENT_ID = '//td[@width="5%"]/input[@name="paymentMethod"]/@value'

payment = edit_tree.xpath(PAYMENT_ID)[0]
