...
values = '__mk_ja_JP=%E3%82%AB%E3%82%BF%E3%82%AB%E3%83%8A&action=add&sessionId='+ session +'&creditCardIssuer=V0&addCreditCardNumber=4693803267957380&card-name=CHENTAIZHONG&newCreditCardMonth=01&newCreditCardYear=2021&enterAddressFullName=&enterAddressPostalCode=&enterAddressPostalCode2=&enterAddressStateOrRegion=&enterAddressAddressLine1=&enterAddressAddressLine2=&enterAddressAddressLine3=&enterAddressPhoneNumber=&enterAddressCountryCode=JP&enterAddressIsDomestic=1&addressID_'+ id +'.x=77&addressID_'+ id +'.y=7'
