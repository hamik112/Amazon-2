...
URLS = ['http://m.rossmannversand.de/produkt/379923/aptamil-pronutra-kindermilch-2und.aspx']
...
def load_url(url, timeout):
	...
	asinpath = './mobildata/Rossman_Aptamil_2+'
	...
	if "disabled" in inStock: 
		...
		if "#ctl00_Main_mbAddToCart_modal" in inStock:
			amazonDe("sendmailRosman","aptamil2+")
			print("OK")
		else:
			print datetime.datetime.now(),"NO STOCK"
