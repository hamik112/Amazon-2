...
URLS = ['http://m.rossmannversand.de/produkt/379924/aptamil-pronutra-kindermilch-1und.aspx']
...
def load_url(url, timeout):
	...
	asinpath = './mobildata/Rossman_Aptamil_1+'
	...
	if "disabled" in inStock: 
		...
		if "#ctl00_Main_mbAddToCart_modal" in inStock:
			amazonDe("sendmailRosman","aptamil1+")
			print("OK")
		else:
			print datetime.datetime.now(),"NO STOCK"
