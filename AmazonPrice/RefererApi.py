...
def get_page(opener,url,data={}):
    headers = {'Referer': 'Dhttp://www.amazon.de/dp/B00BSNAC9C?m=A3JWKAKR8XB7XF',
...
URLS = ['http://www.amazon.de/gp/twister/dimension?asinList=B00BSNAC9C&vs=1&exclusiveMerchantId=A3JWKAKR8XB7XF&productTypeDefinition=GROCERY&productGroupId=grocery_display_on_website&storeId=grocery&parentAsin=B013USRZTW&isPrime=0&nodeID=340846031&isOneClickEnabled=0&webpSupport=1&fastRenderTreatment=C']
num = 1 
