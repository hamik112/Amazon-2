...
if __name__ == '__main__':
    ...
    while 1:
        paramDict = {}
        result = ''
	ys_username = "Ghostbaby"
	ys_password = "jjkcs123"
	ys_softid = "43686"
	ys_softkey = "a4a6bec9bac348fa861ca47e5b26ec45"
        ys_typeid = "3050"
	ys_timeout = "90"
	#act = raw_input('Action:')
        ...
        if cmp(act, 'info') == 0: 
            ...
            paramDict['username'] = ys_username 
            paramDict['password'] = ys_password
            paramDict['typeid'] = ys_typeid
            paramDict['timeout'] = ys_timeout
            paramDict['softid'] = ys_softid
            paramDict['softkey'] = ys_softkey
            paramKeys = ['username',
                 'password',
                 'typeid',
                 'timeout',
